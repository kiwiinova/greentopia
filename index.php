...
<!--     <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
    <script type = "text/javascript" src="../part 3/addtocart.js"></script>
...
<!-- </script> -->
    ...
    <footer>
      <h2>&copy; Copyright Reserved. <a href="../PHP/AdminLogIn_P5.php" class="btnAdmin"><i class="fas fa-user"></i>&nbsp; Admin</a></h2>
    </footer>
  </body>
</html>
